...
export default function NewItem({onAddItem}) {
    ...
    // Function to generate a random string ID with only letters, 4 characters long
    ...
    const handleSubmit = (event) => {
        ...
        const item = { 
            id: generateRandomString(4), //generate a random 4-character string ID
            name, quantity, category
        };

        // Call the onAddItem function passed as a prop with the new item.
        onAddItem(item);
